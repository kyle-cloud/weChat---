 ...
 * ImageIO支持bmp  jpg  wbmp  jpeg  png  gif 6种格式的读写
 * @author 朱志杰 (Thanks for him!)
 */
public class ImageUtil {
    ...
    public static void main(String[] args) {
        ...
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtil.scale("d:/abc.jpg", "d:/abc_scale.jpg", 2, true);//测试OK
        // 方法二：按高度和宽度缩放
        ImageUtil.scale2("d:/abc.jpg", "d:/abc_scale2.jpg", 500, 300, true);//测试OK
        // 2-切割图像：
        // 方法一：按指定起点坐标和宽高切割
        ...
        // 3-图像类型转换：
        ImageUtil.convert("d:/abc.jpg", "GIF", "d:/abc_convert.gif");//测试OK
        // 4-彩色转黑白：
